...
BEGIN	
	...
	EXEC [dbo].[InsertWarning] @TwitchUserId = @TestTwitchUserId, @UserName = @TestUserName, @WarnedBy = @TestWarnedBy, @WarningReason = @TestWarningReason, @WarningTimestampUtc = @TestWarningTimestampUtc, @WarningId = @WarningId OUTPUT;
